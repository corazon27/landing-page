<x-layout.app>
    ...
    ['label' => 'Halaman Portofolio / Galeri Proyek', 'values' => [true, true, true]],
    ['label' => 'Filter Kategori Portofolio', 'values' => [false, true, true]],
...
================================================================ --}}
    <section class="pt-36 pb-14 bg-white">
        <div class="max-w-7xl mx-auto px-5 md:px-6">
            ...
            ['name' => 'Website Company Profile',  'url' => url('/layanan/web-perusahaan')],
        ]" current="Fitur & Harga" />
