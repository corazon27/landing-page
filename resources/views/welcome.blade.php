            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                <div class="md:w-1/2" data-aos="fade-right">
                    ...
                    <h1 class="text-5xl font-extrabold mt-6 mb-6 leading-tight text-slate-900">
                        ...
                        <span class="text-blue-600">Naik Kelas</span>, Gak Pake Ribet.
                    </h1>
                ...
                <div class="md:w-1/2" data-aos="fade-left">
                    <div class="relative">
                        <div class="aspect-square bg-blue-50 rounded-[40px] flex items-center justify-center p-12">
                            <div class="text-center">
                                <div
                                    class="w-20 h-20 bg-blue-600 rounded-2xl flex items-center justify-center text-white text-3xl mx-auto mb-4 shadow-xl">
                                    🤝
                                </div>
                                <p class="text-slate-500 font-medium italic">"Partner diskusi, bukan sekadar vendor."
                                </p>
                            </div>
                        </div>
                    </div>
